    ...
    icon: (
      <div>
        <Image
          height={150}
          width={100}
          src={"/images/custom/repair-water.png"}
          alt="Repair water image"
        />
      </div>
    ),
    title: "Dommages Causés Par La Pénétration D'eau",
    paragraph:
      "Nous pouvons souvent réparer les dégâts d'eau à l'intérieur du téléphone, seuls les rares cas où nous ne pouvons pas réparer cela.",
  },
  {
    id: 1,
    icon: (
      <div>
        <Image
          height={150}
          width={100}
          src={"/images/custom/repair-autonomie.png"}
          alt="Repair autonomie"
        />
      </div>
    ),
    title: "Mauvaise Autonomie De La Batterie",
    paragraph:
      "À mesure que les appareils vieillissent, leurs batteries se dégradent. Avec une nouvelle batterie, vous pouvez profiter de nombreuses heures de charge supplémentaires.",
  },
  {
    id: 1,
    icon: (
      <div>
        <Image
          height={150}
          width={100}
          src={"/images/custom/repair-fissure.png"}
          alt="Repair ecran fissure"
        />
      </div>
    ),
    title: "Écrans Fissurés",
    paragraph:
      "Notre réparation la plus courante ! Nous n'utilisons que des pièces d'origine pour éviter d'annuler votre garantie.",
  },
  {
    id: 1,
    icon: (
      <div>
        <Image
          height={150}
          width={100}
          src={"/images/custom/repair-plie.png"}
          alt="Repair ecran fissure"
        />
      </div>
    ),
    title: "Châssis Plié",
    paragraph:
      "Assis sur votre téléphone ? Nous pouvons redresser votre châssis actuel ou le remplacer par un original d'usine.",
  },
  {
    id: 1,
    icon: (
      <div>
        <Image
          height={150}
          width={100}
          src={"/images/custom/repair-parler.png"}
          alt="Repair haut parleur"
        />
      </div>
    ),
    title: "Haut-Parleurs Cassés",
    paragraph:
      "Beaucoup de choses peuvent causer des haut-parleurs cassés, mais nous pouvons les remplacer facilement pour que vous puissiez entendre à nouveau.",
  },
  // {
  //   id: 1,
  //   icon: (
